...
namespace API.Controllers
{
    ...
    public class ChatController : Controller
    {
        ...
        {
            List<Message> response = _chatRepository.GetMessages(id);
            return Ok(response);
        }
        ...
        {
            List<Message> response = _chatRepository.GetUserMessages(id);
            return Ok(response);
        }
        ...
        {
            List<Message> response = _chatRepository.GetAllUserMessages(id);
            return Ok(response);
        }
    }
}
